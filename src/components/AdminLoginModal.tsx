...
export const AdminLoginModal: React.FC<AdminLoginProps> = ({ inline = false }) => {
  ...
  if (!inline && !adminLoginOpen) return null;
  ...
  const formContent = (
    <div className="relative w-full max-w-sm rounded-none border-4 border-slate-900 bg-white p-6 shadow-[6px_6px_0px_0px_rgba(15,23,42,1)] z-10 text-slate-800">
